...
public class CommonCodeController {
    ...
    @Operation(summary = "캐시된 공통코드 조회", description = "서버 기동 시 admin-service 에서 미리 받아둔 공통코드를 캐시에서 조회한다. admin 실시간 호출 아님")
    @GetMapping("/{groupCode}")
    public ApiResponse<List<AdminCommonCodeDto>> getCommonCodes(@PathVariable String groupCode) {
